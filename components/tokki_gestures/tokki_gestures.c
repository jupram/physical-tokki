...
static const tokki_action_descriptor_t *const ACTIONS[] = {
    ...
    &TOKKI_SPEAKER_BUBBLE_ACTION,
    &TOKKI_SPEAKER_WHISTLE_ACTION,
    &TOKKI_SPEAKER_TONE_LOW_ACTION,
    &TOKKI_SPEAKER_TONE_MID_ACTION,
    &TOKKI_SPEAKER_QUESTION_ACTION,
    &TOKKI_SPEAKER_TONE_HIGH_ACTION,
    &TOKKI_SPEAKER_SPARKLE_ACTION,
    &TOKKI_SPEAKER_TRILL_ACTION,
    &TOKKI_SPEAKER_TONE_RISE_ACTION,
    &TOKKI_SPEAKER_KNOCK_ACTION,
    &TOKKI_SPEAKER_SONAR_ACTION,
    &TOKKI_OLED_LOVEY_DOVEY_ACTION,
    &TOKKI_OLED_SHY_ACTION,
